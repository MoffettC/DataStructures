...
public class DictionaryDriver {
    ...
    public DictionaryDriver() {
        ...
        System.out.println(dictionary.containsWord("iuglans"));
        ...
        if(dictionary.getDefinition(words[0]) != null)
            System.out.println("ERROR, returned deleted definition 1.");
        if(!dictionary.deleteWord(words[1]))
            System.out.println("ERROR, delete FAILED!!!");
        if(dictionary.getDefinition(words[1]) != null)
            System.out.println("ERROR, returned deleted definition 2.");
